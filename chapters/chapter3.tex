...
\end{figure}
\\~\\
As displayed, example is composed of two modules: (i) "Dialogues Greetings and Small Talk" and (ii) "Question Answering System". And each module includes a dialogue tree demonstrating complete dialogue structure for the respective module. So, "Dialogue Tree #1" belongs to greetings module and "Dialogue Tree #2" is linked with Q\&A module. Module and dialogue tree has been explained in the sub-section below.
